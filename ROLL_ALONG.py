...
def winning():
    ...
    nr_wins = FONT.render(str(runs), True, (0, 128, 0))
...
while run:
    ...
    if running:
        ...
        start = FONT.render("Play", True, (0, 128, 0))
        settings = FONT.render("Settings", True, (0, 128, 0))
        leave = FONT.render("Exit", True, (0, 128, 0))
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if (event.key == pygame.K_RETURN)  & (cursor==1):
                    ...
                    while settings:
                        ...
                        Audio = FONT.render("Audio", True, (0, 128, 0))
                        Display = FONT.render("Display", True, (0, 128, 0))
                        Difficulty = FONT.render("Difficulty", True, (0, 128, 0))
                        Hremove = FONT.render("Reset High Score", True, (0, 128, 0))
                        MM = FONT.render("Return To Main Menu", True, (0, 128, 0))
                        cursor_txt3 = FONT3.render(">", True, (50, 30, 150))
                        cursor_txt4 = FONT3.render("_", True, (50, 30, 150))
                        xcom = FONT.render("r- to remove;  i- to insert;  e- easy;  m- moderate;  h- hard", True, (0, 128, 0))
                        high_score = FONT2.render("Best Run: " + current, True, (0, 128, 0))            
                        easy = FONT2.render("Skill: Easy", True, (0, 128, 0))
                        moderate = FONT2.render("Skill: Moderate", True, (0, 128, 0))
                        hard = FONT2.render("Skill: Hard", True, (0, 128, 0))
